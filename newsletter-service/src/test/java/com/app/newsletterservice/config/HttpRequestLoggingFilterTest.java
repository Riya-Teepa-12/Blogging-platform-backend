package com.app.newsletterservice.config;
...
class HttpRequestLoggingFilterTest {
    ...
    void shouldSkipFrameworkPaths() {
        ...
        assertThat(filter.shouldNotFilter(new MockHttpServletRequest("GET", "/newsletter"))).isFalse();
    }

    @Test
    void doFilterInternalRunsChain() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/newsletter");
