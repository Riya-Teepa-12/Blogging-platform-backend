package com.app.newsletterservice.coverage;
...
class NewsletterModelCoverageTest {

    @Test
    void exerciseNewsletterModels() {
        List<Class<?>> classes = List.of(
                DispatchResponse.class,
                SendNewsletterRequest.class,
                SendPostNotificationRequest.class,
    ...
    private Object sampleValue(Class<?> type) {
        ...
        if (type == LocalDateTime.class) {
            return LocalDateTime.of(2025, 5, 1, 10, 30);
        }
        if (type == Instant.class) {
            return Instant.parse("2025-05-01T00:00:00Z");
        }
