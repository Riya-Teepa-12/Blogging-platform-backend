package com.app.notificationservice.coverage;
...
import com.app.notificationservice.messaging.NotificationDispatchEvent;

class NotificationModelCoverageTest {

    @Test
    void exerciseNotificationModels() {
        List<Class<?>> classes = List.of(
                BulkNotificationRequest.class,
    ...
    private Object sampleValue(Class<?> type) {
        ...
        if (type == LocalDateTime.class) {
            return LocalDateTime.of(2025, 6, 1, 11, 0);
        }
