package com.app.mediaservice.coverage;
...
class MediaModelCoverageTest {

    @Test
    void exerciseMediaModels() {
        List<Class<?>> classes = List.of(
                LinkPostRequest.class,
                MediaResponse.class,
                UpdateAltTextRequest.class,
                Media.class);
    ...
    private Object sampleValue(Class<?> type) {
        ...
        if (type == LocalDateTime.class) {
            return LocalDateTime.of(2025, 4, 1, 8, 0);
        }
